...
local togglekey = gui.Keybox(dmgsettings, "ChangeDmgKey", "Mindamage Key", 71)
...
local awpori = gui.Slider(awpdmg, "awpori", "Awp Original Min Damage", 1, 1, 130)
local awpDamage = gui.Slider(awpdmg, "awpDamage", "Awp Min Damage Override", 1, 1, 130)
local scoutdmg = gui.Groupbox(tab,"Scout Damage Settings",310,16,280,300)
local scoutori = gui.Slider(scoutdmg, "scoutori", "Scout Original Min Damage", 1, 1, 130)
local scoutDamage = gui.Slider(scoutdmg, "scoutDamage", "Scout Min Damage Override", 1, 1, 130)
local autodmg = gui.Groupbox(tab,"Auto Damage Settings",310,190,280,300)
local autoori = gui.Slider(autodmg, "autoori", "Auto Original Min Damage", 1, 1, 130)
local autoDamage = gui.Slider(autodmg, "autoDamage", "Auto Min Damage Override", 1, 1, 130)
...
local ypos = gui.Slider(position, "ypos", "Y Position", 570, 0, 1080)
local Toggle =-1
local pressed = false
