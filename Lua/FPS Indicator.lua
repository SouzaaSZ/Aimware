...
local fps_check = gui.Checkbox(menu_ref, "check_fps", "FPS indicator.", false)
fps_check:SetDescription("Show your FPS at bottom of screen.")
...
local function on_draw()
    ...
    if not lp:IsAlive() or not fps_check:GetValue() then
        return
    end
    ...
    draw.Text(screen_w - 81, screen_h + 6, "PING")
    draw.Text(screen_w + 5, screen_h + 6, "FPS")
    draw.Text(screen_w + 82, screen_h + 6, "SPEED")
end
